    ...
    <div className="home">
      ...
      <div className="explore" id="explores">
        <div className="container">
          ...
          <div className="items">
            <div className="item" onClick={()=>navigate("/gigs?category=design")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=social")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=writing&Translation")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=video")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=voice")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=tech")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=seo")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=books")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=dataentry")}>
              <img
            ...
            <div className="item" onClick={()=>navigate("/gigs?category=photography")}>
              <img
